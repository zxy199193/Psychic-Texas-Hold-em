...
SKILL_DESC_11,选择场上玩家一张底牌发动，这张牌被遮挡，且免疫[透视]、[变牌]、[交换],Shields a hole card from view and makes it immune to Peek, Swap, and Exchange.,技能11描述
