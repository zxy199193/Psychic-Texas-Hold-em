...
data = [
    ...
    # Skills 1-20 (完全严格对照 Poker.xlsx Sheet1 最新顺序)
    ...
    ("SKILL_NAME_7", "颠倒", "Upsidedown", "技能7"),
    ("SKILL_DESC_7", "选择一名玩家发动，该玩家这局游戏画面颠倒", "Target player's view becomes inverted upside down for this hand.", "技能7描述"),
    ("SKILL_NAME_8", "迟钝", "Slow", "技能8"),
    ("SKILL_DESC_8", "选择一名玩家发动，该玩家这局游戏所有技能的发动时间x2", "Doubles all skill casting times for the target player for this hand.", "技能8描述"),
    ("SKILL_NAME_9", "枷锁", "Chain", "技能9"),
    ("SKILL_DESC_9", "选择一名玩家发动，该玩家这局游戏只能再使用3次技能", "Target player can only cast skills up to 3 more times this hand.", "技能9描述"),
    ("SKILL_NAME_10", "共鸣", "Resonance", "技能10"),
    ("SKILL_DESC_10", "如果场上其他玩家有和你同类的牌型，这些牌会进行闪烁", "Highlights matching poker hand components if opponents hold similar card combinations.", "技能10描述"),
    ("SKILL_NAME_11", "援助", "Help", "技能11"),
    ("SKILL_DESC_11", "选择一名玩家发动，恢复其3点能量", "Restores 3 energy points to the target player.", "技能11描述"),
    ("SKILL_NAME_12", "封印", "Seal", "技能12"),
    ("SKILL_DESC_12", "选择场上玩家一张底牌发动，这张牌被遮挡，且免疫[透视]、[变牌]、[交换]", "Shields a hole card from view and makes it immune to Peek, Change, and Swap.", "技能12描述"),
    ("SKILL_NAME_13", "灵机", "Idea", "技能13"),
    ("SKILL_DESC_13", "发动后这局游戏该技能会随机变成其他任意技能", "Randomly transforms this skill into any other skill for the rest of this hand.", "技能13描述"),
    ("SKILL_NAME_14", "透支", "Overdraw", "技能14"),
    ("SKILL_DESC_14", "能量恢复至最大，但接下来三局无法使用任何技能", "Instantly restores energy to maximum, but disables all skill casting for the next 3 hands.", "技能14描述"),
    ("SKILL_NAME_15", "交换", "Swap", "技能15"),
    ("SKILL_DESC_15", "选择场上任意2张牌发动，将这2张牌进行调换", "Swaps any two cards currently in play.", "技能15描述"),
    ("SKILL_NAME_16", "许愿", "Wish", "技能16"),
    ("SKILL_DESC_16", "发动后下一局游戏的2张底牌必定是JQKA", "Guarantees both hole cards in the next hand will be among J, Q, K, A.", "技能16描述"),
    ("SKILL_NAME_17", "重力场", "Gravity", "技能17"),
    ("SKILL_DESC_17", "这局游戏场上能量最高的玩家所有技能能量消耗+2", "Increases skill energy cost by 2 for the player with the highest current energy.", "技能17描述"),
    ("SKILL_NAME_18", "戏法空间", "Zone", "技能18"),
    ("SKILL_DESC_18", "这局游戏场上所有玩家所有技能的能量消耗随机增加或降低0~2点", "Randomly alters energy cost of all skills for all players by -2 to +2 for this hand.", "技能18描述"),
    ("SKILL_NAME_19", "反射壁", "Reflect", "技能19"),
    ("SKILL_DESC_19", "发动后这局游戏受到其他玩家的技能时，技能会被反弹给其他任意一名玩家", "Reflects any incoming offensive skill to a random other player for this hand.", "技能19描述"),
    ("SKILL_NAME_20", "精神控制", "Control", "技能20"),
    ("SKILL_DESC_20", "选择一名玩家发动，该玩家这局游戏无法弃牌", "Prevents target player from folding for the rest of this hand.", "技能20描述"),

    # Trinkets 1-20 (完全严格对照 Poker.xlsx Sheet1 最新顺序)
    ...
    ("TRINKET_NAME_4", "怀表", "Watch", "饰品4"),
    ("TRINKET_DESC_4", "所有技能发动时间-70%", "Skill casting time -70%", "饰品4描述"),
    ("TRINKET_NAME_5", "啤酒", "Beer", "饰品5"),
    ("TRINKET_DESC_5", "每次加注恢复1点能量", "Restores 1 energy point every time you raise", "饰品5描述"),
    ("TRINKET_NAME_6", "磁线圈", "Coil", "饰品6"),
    ("TRINKET_DESC_6", "能量上限-6，能量恢复-2，每当其他玩家成功发动技能，恢复1点能量", "Max energy -6, energy recovery -2. Restores 1 energy whenever any opponent successfully casts a skill.", "饰品6描述"),
    ("TRINKET_NAME_7", "兽爪", "Claw", "饰品7"),
    ("TRINKET_DESC_7", "如果只选择了2个技能，对方抵抗这两个技能需要额外消耗1点能量", "If equipping only 2 skills, opponents need 1 extra energy to resist them.", "饰品7描述"),
    ("TRINKET_NAME_8", "斗篷", "Cloak", "饰品8"),
    ("TRINKET_DESC_8", "[抵抗]能量消耗-1", "Resist skill energy cost -1", "饰品8描述"),
    ("TRINKET_NAME_9", "天线", "Antenna", "饰品9"),
    ("TRINKET_DESC_9", "[感应]不消耗能量且显示玩家饰品", "Sense costs 0 energy and reveals opponent trinkets", "饰品9描述"),
    ("TRINKET_NAME_10", "帽子", "Hat", "饰品10"),
    ("TRINKET_DESC_10", "发动技能时不会被[感应]效果感知", "Skill casting will not trigger Sense alerts", "饰品10描述"),
    ("TRINKET_NAME_11", "镜片", "Glass", "饰品11"),
    ("TRINKET_DESC_11", "[透视]将会额外随机显示场上一张牌", "Peek reveals 1 additional random card in play", "饰品11描述"),
    ("TRINKET_NAME_12", "眼药", "Eyedrop", "饰品12"),
    ("TRINKET_DESC_12", "[透视]显示时间提升至60秒", "Peek duration increased to 60 seconds", "饰品12描述"),
    ("TRINKET_NAME_13", "戒指", "Ring", "饰品13"),
    ("TRINKET_DESC_13", "[变牌]和[交换]可以对公牌使用", "Change and Swap can now target community cards", "饰品13描述"),
    ("TRINKET_NAME_14", "音叉", "Fork", "饰品14"),
    ("TRINKET_DESC_14", "[干扰]的技能效果+25%", "Interfere failure chance increased by 25%", "饰品14描述"),
    ("TRINKET_NAME_15", "香薰", "Aroma", "饰品15"),
    ("TRINKET_DESC_15", "[迟钝]的技能效果改为x3", "Slow casting time multiplier increased to 3x", "饰品15描述"),
    ("TRINKET_NAME_16", "仙女棒", "Wand", "饰品16"),
    ("TRINKET_DESC_16", "第一次使用[灵机]变化的技能时能量消耗-2", "First cast of the skill transformed by Idea costs -2 energy", "饰品16描述"),
    ("TRINKET_NAME_17", "可乐", "Cola", "饰品17"),
    ("TRINKET_DESC_17", "[透支]的技能禁用时间减为2局", "Overdraw skill lockout reduced to 2 hands", "饰品17描述"),
    ("TRINKET_NAME_18", "神像", "Statue", "饰品18"),
    ("TRINKET_DESC_18", "[许愿]获得的牌必定是QKA（和魔像互斥）", "Wish cards are guaranteed to be Q, K, or A (Exclusive with Golem)", "饰品18描述"),
    ("TRINKET_NAME_19", "魔像", "Golem", "饰品19"),
    ("TRINKET_DESC_19", "[许愿]获得的牌必定能凑成三条，但该局无法加注（和神像互斥）", "Wish cards guarantee Three of a Kind, but cannot raise this hand (Exclusive with Statue)", "饰品19描述"),
    ("TRINKET_NAME_20", "袖章", "Armband", "饰品20"),
    ("TRINKET_DESC_20", "当玩家为场上亏损最高时，所有技能能量消耗-2（最低为1）", "When you have the largest chip loss at the table, all skill costs -2 (min 1).", "饰品20描述"),
