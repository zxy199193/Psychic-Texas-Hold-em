...
public class CardView : MonoBehaviour
{
    ...
    public void StartBlinking(float duration)
    {
        ...
        Transform oldMask = this.transform.Find("BlinkWhiteMask");
        if (oldMask != null)
        {
            Destroy(oldMask.gameObject);
        }
    ...
    {
        GameObject maskObj = new GameObject("BlinkWhiteMask");
        maskObj.transform.SetParent(this.transform, false);
        ...
        Tween blinkTween = maskImage.DOColor(new Color(1f, 1f, 1f, 0.8f), 0.25f)
